      ...
      <Navbar>
          ...
          <div className="flex items-center gap-4">
            <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-lg leading-6  text-white inline-block">
              <span className="absolute inset-0 overflow-hidden rounded-full">
                <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(circle at top left, rgba(255,255,255,0.05), transparent), radial-gradient(circle at top right, rgba(255, 168, 255, 0.07), transparent), linear-gradient(135deg, #090025 0%, #1c0049 50%, #140117 100%) opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
              </span>
        ...
        <MobileNav>
          ...
          >
            ...
            <div className="flex w-full flex-col gap-4 items-cente justify-center">
              <NavbarButton
                onClick={() => setIsMobileMenuOpen(false)}
                variant="primary"
                className="w-full"
