...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[600px] -inset-0 mb-0 flex-col items-center justify-center overflow-clip bg-black w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-100 md-0 h-50 items-center justify-center isolate z-0 mt-80 ">
        <motion.div
      ...
      <div className="relative z-50 flex -translate-y flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
